...
class CTMDNXCell(nn.Module):
    ...
    def forward(self, x, h, mem_alpha, mem_beta):
        ...
        for _ in range(self.unfolds):
            ...
            if self.training:
                current_h.retain_grad()
            self.h_trajectory.append(current_h)
...
if __name__ == "__main__":
    ...
    # 实例化模型
    model = CTMDNXClassifier(INPUT_SIZE, HIDDEN_SIZE, OUTPUT_SIZE, unfold=4)
